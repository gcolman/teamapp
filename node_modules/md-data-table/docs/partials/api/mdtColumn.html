<h1><code ng:non-bindable="">mdtColumn</code>
<div><span class="hint"></span>
</div>
</h1>
<div><h2 id="description">Description</h2>
<div class="description"><div class="mdtcolumn-page"><p>Representing a header column cell which should be placed inside <code>mdt-header-row</code> element directive.</p>
</div></div>
<h2 id="dependencies">Dependencies</h2>
<ul class="dependencies"><li><code ng:non-bindable=""><a href="api/mdtTable">mdtTable</a></code>
</li>
</ul>
<h2 id="usage">Usage</h2>
<div class="usage">as element:<pre class="prettyprint linenums">&lt;mdt-column
       [align-rule="{string}"]
...
<p> When object is passed, then compare function can be passed for sorting the column data&#39;s. As every compare
 function, it gets two parameters and return with the compared result (-1,1,0)</p>
<p>Assignable values:</p>
<ul>
<li>true or false</li>
<li>{ comparator: function(a,b)}</li>
</ul>
</div></td></tr><tr><td>columnFilter <div><em>(optional)</em></div></td><td><a href="" class="label type-hint type-hint-object">object</a></td><td><div class="mdtcolumn-page"><p>if provided, user can activate column filter feature on the selected column</p>
<p> Assignable properties:</p>
<pre><code>- {Function=} valuesProviderCallback required, function which provides the values into the column filter. It must return with a promise which resolves an array of strings/objects
